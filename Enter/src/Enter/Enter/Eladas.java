...
static Integer Osszeg = null;
    ...
    public Eladas() {
        ...
        jT_Szamla.setFont(new Font("Arial", Font.ITALIC, 18));
    ...
    private void initComponents() {
        ...
        jT_Szamla.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        ...
        jScrollPane2.setViewportView(jT_Szamla);
        ...
        jTF_Osszeg.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            ...
                                            .addComponent(jTF_Osszeg, javax.swing.GroupLayout.Alignment.LEADING))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTF_Osszeg, javax.swing.GroupLayout.DEFAULT_SIZE, 39, Short.MAX_VALUE)))
        ...
        if (!jTextField_Mennyiseg.getText().equals(""))
        {
            ...
            if ((dm.getRowCount()>0))
            {
                while (ok && i<dm.getRowCount())
                {
                    ...
                    {
                        ujertek=Integer.parseInt(jT_Szamla.getModel().getValueAt(i, 3).toString())+Integer.parseInt(jTextField_Mennyiseg.getText());
                ...
                if (i>=dm.getRowCount())
                {
                    ...
                    dm.addRow(new Object[]{szlasz,cikkszam,termeknev,jTextField_Mennyiseg.getText(),Ar,Into.F_id,Fizetendo});
    ...
    private void jB_FizetesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jB_FizetesActionPerformed
        ...
        int eladott_termek_keszlet=0;
            ...
            try
                ...
                String s="C:\\Users\\user10.VEREBELY\\Documents\\NetBeansProjects\\Enter\\Nyugta/"+Integer.toString(szlasz)+".txt";
                try
                {
